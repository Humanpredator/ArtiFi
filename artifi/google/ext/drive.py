...
from artifi.utils import DriveSetInterval, fetch_mime_type, readable_size
    ...
    def cloneFolder(self, local_path, folder_id, parent_id):
        ...
        for file in files:
            if file.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                self.cloneFolder(file_path, file.get("id"), current_dir_id)
            else:
                try:
                    self.total_files += 1
    ...
    def clone(self, link):
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                self.cloneFolder(meta.get("name"), meta.get("id"), dir_id)
